...
export default function Header() {
  ...
  return (
    <header
      ...
      className={`relative flex text-center justify-center font-bold mb-4 sm:mb-0 p-4 gap-4 flex-wrap border-b-1 sm:border-0 border-gray-900 bg-gray-900/25 sm:bg-transparent`}
