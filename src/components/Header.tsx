...
export default function Header() {
  ...
  return (
    <header
      ...
      className="relative flex text-center justify-between p-3 after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-3/4 after:h-[1px] after:bg-gradient-to-r after:from-transparent after:via-gray-800 after:to-transparent"
    >
      <h1
        aria-label="logo"
